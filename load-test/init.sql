...
-- ── 테스트 유저 ──
INSERT INTO users (user_id, email, nickname, profile_image, social_id, personal_info_agreement, marketing_agreement, role, created_at, updated_at)
VALUES
...
INSERT INTO event (event_id, event_name, event_date_time, created_at, updated_at)
VALUES
...
-- ── 출발지 (각 이벤트에 3명 참여자) ──
-- 이벤트 1 출발지: 강남, 홍대, 잠실
INSERT INTO start_point (start_point_id, event_id, user_id, start_point_name, is_user, is_transit, road_longitude, road_latitude, address, road_address, point, created_at, updated_at)
VALUES
